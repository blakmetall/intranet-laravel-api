...
class CreateQualityVisitExtensionRequestsTable extends Migration
{

    public $set_schema_table = 'quality_visit_extension_requests';
    ...
    public function up(){
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            $table->increments('id');
            $table->integer('quality_assurance_visit_id');
